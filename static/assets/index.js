...
function registerUser() {
  ...
  $.get("/register/begin/" + username, null, function(data) {
    return data;
    ...
    $.post("/register/finish/" + username, JSON.stringify({
      id: credential.id,
...
function loginUser() {
  let username2 = $("#email").val();
  if (username2 === "") {
    alert("Please enter a username");
    return;
  }
  $.get("/login/begin/" + username2, null, function(data) {
    return data;
  }, "json").then((credentialRequestOptions) => {
    ...
    $.post("/login/finish/" + username2, JSON.stringify({
      id: assertion.id,
      rawId: bufferEncode(rawId),
      type: assertion.type,
      response: {
    ...
    alert("successfully logged in " + username2 + "!");
    ...
    alert("failed to register " + username2);
  });
}
...
function LoginPage() {
  return /* @__PURE__ */ React.createElement("div", null, "Username:", /* @__PURE__ */ React.createElement("input", {
    type: "text",
    name: "username",
    id: "email",
    value: "larry",
...
$$1(function() {
  const goTopElement2 = $$1("#root").get(0);
  if (goTopElement2) {
    const root = client.createRoot(goTopElement2);
