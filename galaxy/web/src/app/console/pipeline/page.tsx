...
import {PipelineServer} from '@/services/server/pipeline'
...
export default async function Page ({searchParams}: {
  ...
  const result = await PipelineServer.selectModels(accessToken, rawQuery)
  ...
  return <div>
    ...
    <div className={styles.tableContainer}>
      <Table data={result as SelectResult<PipelineModel>} rawQuery={rawQuery}/>
    </div>
  </div>
}
