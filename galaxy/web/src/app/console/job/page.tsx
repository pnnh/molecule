...
import {JobServer} from '@/services/server/job'
...
export default async function Page ({searchParams}: {
  ...
  const result = await JobServer.selectModels(accessToken, rawQuery)
  ...
  return <div>
    ...
    <div className={styles.tableContainer}>
      <Table data={result as SelectResult<JobModel>} rawQuery={rawQuery}/>
    </div>
  </div>
}
