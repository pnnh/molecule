...
export function Table (props: {
  data: SelectResult<ParameterModel>,
  rawQuery: string,
}) {
  ...
  const goPage = (page: number, pageSize: number) => {
    ...
    const redirectUrl = '/console/Parameter?' + queryString.stringify(queryObject)
...
function TableRow (props: { model: ParameterModel }) {
...
function calcOperatorItems (model: ParameterModel): MenuProps {
