...
import {TaskServer} from '@/services/server/task'
...
export default async function Page ({searchParams}: {
  ...
  const result = await TaskServer.selectModels(accessToken, rawQuery)
  ...
  return <div>
    ...
    <div className={styles.tableContainer}>
      <Table data={result as SelectResult<TaskModel>} rawQuery={rawQuery}/>
    </div>
  </div>
}
