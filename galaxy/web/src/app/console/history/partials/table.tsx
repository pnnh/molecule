...
export function Table (props: {
  data: SelectResult<HistoryModel>,
  rawQuery: string,
}) {
  ...
  const goPage = (page: number, pageSize: number) => {
    ...
    const redirectUrl = '/console/History?' + queryString.stringify(queryObject)
...
function TableRow (props: { model: HistoryModel }) {
...
function calcOperatorItems (model: HistoryModel): MenuProps {
