...
export async function signupByMailBegin (username: string, nickname: string) {
  const response = await axios.post<CommonReslut<{ session: string }>>('/account/signup/email/begin',
    {username, nickname},
    {
      headers: {},
    }).catch((error) => {
...
export async function signupByMailFinish (session: string, code: string) {
  const response = await axios.post<CommonReslut<string>>('/account/signup/email/finish',
    {session, code},
    {
      headers: {},
    }).catch((error) => {
...
export async function signinByMailBegin (username: string) {
  const response = await axios.post<CommonReslut<{ session: string }>>('/account/signin/email/begin',
    {username},
    {
      headers: {},
    }).catch((error) => {
...
export async function signinByMailFinish (session: string, code: string) {
  const response = await axios.post<CommonReslut<string>>('/account/signin/email/finish',
    {session, code},
    {
      headers: {},
    }).catch((error) => {
...
export async function signupByPasswordBegin (username: string, nickname: string) {
  const response = await axios.post<CommonReslut<{ session: string }>>('/account/signup/password/begin',
    {username, nickname},
    {
      headers: {},
    }).catch((error) => {
...
export async function signupByPasswordFinish (session: string, password: string) {
  const response = await axios.post<CommonReslut<string>>('/account/signup/password/finish',
    {session, password},
    {
      headers: {},
    }).catch((error) => {
...
export async function signinByPasswordBegin (username: string) {
  const response = await axios.post<CommonReslut<{ session: string }>>('/account/signin/password/begin',
    {username},
    {
      headers: {},
    }).catch((error) => {
...
export async function signinByPasswordFinish (session: string, password: string) {
  const response = await axios.post<CommonReslut<string>>('/account/signin/password/finish',
    {session, password},
    {
      headers: {},
    }).catch((error) => {
