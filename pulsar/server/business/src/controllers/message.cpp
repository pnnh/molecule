...
void MessageController::HandleGet(boost::beast::http::request<boost::beast::http::dynamic_body> &request,
...
void MessageController::HandleDelete(boost::beast::http::request<boost::beast::http::dynamic_body> &request,
                                     boost::beast::http::response<boost::beast::http::dynamic_body> &response) {
...
void MessageController::HandleInsert(boost::beast::http::request<boost::beast::http::dynamic_body> &request,
                                     boost::beast::http::response<boost::beast::http::dynamic_body> &response) {
...
void MessageController::HandleSelect(boost::beast::http::request<boost::beast::http::dynamic_body> &request,
                                     boost::beast::http::response<boost::beast::http::dynamic_body> &response) {
...
void MessageController::HandleUpdate(boost::beast::http::request<boost::beast::http::dynamic_body> &request,
                                     boost::beast::http::response<boost::beast::http::dynamic_body> &response) {
    response.result(boost::beast::http::status::ok);
    response.keep_alive(false);
    response.set(boost::beast::http::field::server, "Beast");
