...
MessageService::selectMessages(int limit)
{
  ...
  const char *sqlText = "select uid, nid, title, header, body, keywords, description, create_time, update_time "
...
MessageService::findMessage(const std::optional<std::string> &uid, const std::optional<long> &nid)
{
  std::string sqlText = "select uid, nid, title, header, body, keywords, description, create_time, update_time "
                        "from posts where ";
