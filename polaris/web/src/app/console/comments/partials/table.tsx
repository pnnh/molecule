...
export function Table (props: { data: PLSelectResult<CommentModel> }) {
...
function TableRow (props: { model: CommentModel }) {
  ...
  return <tr className={styles.Row}>
    ...
    <td>
      <Link href={'/console/comments/update?pk=' + props.model.pk}
...
//           const result = await CommentClientPresenter.deleteModel(props.pk)
