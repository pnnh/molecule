...
export function Table (props: { data: PLSelectResult<GroupModel> }) {
...
function TableRow (props: { model: GroupModel }) {
  ...
  return <tr className={styles.Row}>
    ...
    <td>
      <Link href={'/console/groups/update?pk=' + props.model.pk}
...
function DeleteButton () {
  ...
  //         const result = await GroupClientPresenter.deleteModel(props.pk)
